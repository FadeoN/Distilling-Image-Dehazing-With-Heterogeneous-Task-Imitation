...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument('--load-best-model', action='store_true', default=False, help='Load the model weight from given path.')
        ...
        parser.add_argument('--val-ratio', type=lambda x: utils.restricted_float(x, [0., 1.]), default=0.10, metavar='val_ratio',
